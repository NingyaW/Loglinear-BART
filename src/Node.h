...
public:
	...
	double** GetFits(void* model,int  nTrain,double** dTrain, double** dTrainR,double* yTrain,double* deTrain,double* wiTrain,double* vTrain, int nTest, double** dTest, double** dTestR, double* w);
	double** GetEstimates(void* model,int  nTrain,double** dTrain, double** dTrainR,double* yTrain,double* deTrain,double* wiTrain,double* vTrain, double* w);
        //void  currentFits(MuS* mod,int nTrain,double** xTrain,double* yTrain,int nTest,double** xTest,double* w, Lib& gen, double** fits);
        void  currentFits(MuS* mod,int nTrain,double** xTrain,double* yTrain,double* deTrain,double* wiTrain,double* vTrain,int nTest,double** xTest,double* w, double** fits);
